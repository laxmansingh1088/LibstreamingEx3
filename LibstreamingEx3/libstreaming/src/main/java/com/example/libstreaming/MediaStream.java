...
import com.example.libstreaming.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(com.example.libstreaming.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(com.example.libstreaming.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link com.example.libstreaming.rtp.RtpSocket}.
	...
	protected void createSockets() throws IOException {
		...
		if (sPipeApi == PIPE_API_LS) {
			...
			final String LOCAL_ADDR = "com.example.libstreaming-";
