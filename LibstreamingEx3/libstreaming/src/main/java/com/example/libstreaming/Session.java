...
import com.example.libstreaming.audio.AudioStream;
import com.example.libstreaming.exceptions.CameraInUseException;
import com.example.libstreaming.exceptions.ConfNotSupportedException;
import com.example.libstreaming.exceptions.InvalidSurfaceException;
import com.example.libstreaming.exceptions.StorageUnavailableException;
import com.example.libstreaming.gl.SurfaceView;
import com.example.libstreaming.rtsp.RtspClient;
import com.example.libstreaming.video.VideoQuality;
import com.example.libstreaming.video.VideoStream;
...
public class Session {
	...
	public Session() {
		...
		HandlerThread thread = new HandlerThread("com.example.libstreaming.Session");
		thread.start();
